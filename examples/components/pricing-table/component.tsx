            ...
            >
              <div>
                <div className="flex items-center justify-between gap-x-4">
                  <h3
                    className={`text-lg leading-8 font-semibold ${tier.highlighted ? 'text-white' : 'text-gray-900'}`}
                  >
                    {tier.name}
                  </h3>
                </div>
              ...
              <a
                href={tier.ctaUrl}
                className={`mt-8 block rounded-md px-3 py-2 text-center text-sm leading-6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                  tier.highlighted
